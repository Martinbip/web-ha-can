export const RESOURCE_CONFIG = {
  ...
  'products': {
    ...
    fields: {
      ...
      price: { label: 'Giá', type: 'number', placeholder: 'Bỏ trống nếu báo giá theo liên hệ', hint: 'Bỏ trống để website hiển thị chữ ở ô "Chữ hiển thị khi không có giá" thay vì con số.', emptyText: 'Liên hệ' },
      price_unit: { label: 'Đơn vị giá', type: 'text', placeholder: 'đ/kg', hint: 'Ghi liền ngay sau con số, ví dụ đ/kg, đ/tấn. Bỏ trống sẽ dùng đ/kg.' },
      price_label: { label: 'Chữ hiển thị khi không có giá', type: 'text', placeholder: 'Liên hệ', hint: 'Ví dụ: Liên hệ, Báo giá theo lô. Bỏ trống sẽ dùng "Liên hệ".' },
