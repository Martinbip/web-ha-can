export const RESOURCE_CONFIG = {
  ...
  'site-setting': {
    ...
    fields: {
      ...
      header_cta_label: { label: 'Chữ nút đầu trang', type: 'text', placeholder: 'Yêu Cầu Mẫu', hint: 'Nút nổi bật góc phải đầu trang, trên mọi trang. Bỏ trống thì website giữ chữ đang hiện (lúc đầu là "Yêu Cầu Mẫu").' },
      header_cta_url: { label: 'Link nút đầu trang', type: 'text', placeholder: '/contact', hint: 'Bắt đầu bằng "/" (trang trong website), "#" hoặc "https://". Bỏ trống hoặc sai quy tắc thì nút giữ link đang dùng (lúc đầu là /contact).' },
      footer_categories_title: { label: 'Tiêu đề cột danh mục (chân trang)', type: 'text', placeholder: 'DANH MỤC SẢN PHẨM', hint: 'Bỏ trống thì giữ tiêu đề đang hiện (lúc đầu là "DANH MỤC SẢN PHẨM"). Các dòng trong cột lấy từ trang Danh mục sản phẩm.' },
      footer_links_title: { label: 'Tiêu đề cột liên kết (chân trang)', type: 'text', placeholder: 'HỖ TRỢ KHÁCH HÀNG', hint: 'Bỏ trống thì giữ tiêu đề đang hiện (lúc đầu là "HỖ TRỢ KHÁCH HÀNG").' },
      footer_links: { label: 'Liên kết chân trang', type: 'link-list', hint: 'Các link trong cột liên kết ở chân trang mọi trang; website hiện đúng các link đang bật "Hiện". Tắt hết hoặc xoá hết thì website giữ nguyên các link đang hiện chứ không để trống cột.' },
      copyright_text: { label: 'Dòng bản quyền', type: 'text', placeholder: 'Kim Loại Màu DHA. Bản quyền được bảo lưu.', hint: 'Website tự thêm "© <năm hiện tại>" đằng trước. Bỏ trống thì giữ dòng đang hiện.' },
