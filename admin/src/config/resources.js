export const RESOURCE_CONFIG = {
  ...
  'hero-slides': { label: 'Hero slide', titleField: 'title', draftAndPublish: true, listFields: ['title', 'subtitle', 'sort_order', 'publishedAt'], fields: { subtitle: { label: 'Dòng phụ', type: 'text', required: true }, title: { label: 'Tiêu đề', type: 'text', required: true }, image_url: { label: 'Ảnh slide', type: 'cloudinary-image', folder: 'dha/hero' }, image_alt: { label: 'Mô tả ảnh', type: 'textarea' }, sort_order: { label: 'Thứ tự', type: 'number' } } },
